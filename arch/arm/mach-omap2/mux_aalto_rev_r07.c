 ...
 */
	...
	// 47 (L3, H, GPIO_42, VOL_DOWN_KEY)	//aalto jmin
	OMAP3_MUX(GPMC_A9,	OMAP_MUX_MODE4 | OMAP_PIN_INPUT),
	// 48 (D4, H, GPIO_43, VOL_UP_KEY)	//aalto jmin
	...
	// 57 (N2, H, GPMC_D8, GPMC_D8, I/O)  //aalto hoeun
	OMAP3_MUX(GPMC_D8,	 OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 58 (P1, H, GPMC_D9, GPMC_D9, I/O)  //aalto hoeun
	OMAP3_MUX(GPMC_D9,	 OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 59 (R1, H, GPMC_D10, GPMC_D10, I/O) //aalto hoeun
	OMAP3_MUX(GPMC_D10,    OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 60 (U2, H, GPMC_D11, GPMC_D11, I/O) // aalto hoeun
	OMAP3_MUX(GPMC_D11,    OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 61 (V3, H, GPMC_D12, GPMC_D12, I/O) // aalto hoeun
	OMAP3_MUX(GPMC_D12,   OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	...
	// 67 (V8, H, GPIO_53, PS_OUT, I[H], OFF[H])  // aakto hoeun
	...
	// 77 (G3, L, GPMC_NBE0_CLE, GPMC_NBE0, O) // aalto hoeun
	OMAP3_MUX(GPMC_NBE0_CLE,  OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 78 (U3, L, GPMC_NBE1, GPMC_NBE1, O) //aalto hoeun
	OMAP3_MUX(GPMC_NBE1,   OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN), // LCD_ID2
	...
	OMAP3_MUX(MCBSP3_DX,  OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_INPUT_PULLUP | OMAP_WAKEUP_EN),
	...
	OMAP3_MUX(MCBSP3_CLKX, OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLUP | OMAP_OFF_EN | OMAP_OFFOUT_EN),
	...
	// 213 (H9, L, GPIO_178, IPC_SPI_CLK, 0) // aalto hoeun
	OMAP3_MUX(MCSPI2_CLK,    OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 214 (J10, L, GPIO_179, IPC_SPI_MOSI, 0) // aalto hoeun
	OMAP3_MUX(MCSPI2_SIMO,  OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 215 (H10, L, GPIO_180, IPC_SPI_MISO, 0) // aalto hoeun
	OMAP3_MUX(MCSPI2_SOMI, OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
	// 216 (H11, H, GPIO_181, IPC_SRDY, 0) // aalto hoeun
	...
	// 301 (AA11, H, SAFE_MODE, GPIO_11, N/C) //hoeun aalto
	OMAP3_MUX(JTAG_EMU0,   OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN | OMAP_PIN_OFF_INPUT_PULLUP),
	// 302 (W10, H, SAFE_MODE, N/C) - 09/17  //hoeun aalto
	OMAP3_MUX(JTAG_EMU1,  OMAP_MUX_MODE4| OMAP_PIN_INPUT_PULLDOWN),
